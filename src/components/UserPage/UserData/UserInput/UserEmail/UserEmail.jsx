...
export default function UserInputEmail() {
  ...
  <BoxInput>
    <TextField>Email: </TextField>
      <div>
        {disabled ? <InputForm value={user.email} type="text" disabled={disabled} ></InputForm> : <InputForm value={user.email} type="text" style={{background : "#FDF7F2",border: "1px solid rgba(245, 146, 86, 0.5)"} } disabled={disabled}></InputForm> }
      </div>
